...
feedRouter.get('/stream', (req, res) => {
    const sessionId = req.query.sessionId;
    // If the caller pinned a sessionId that isn't the active one, this is
    // an archive view; send a hello and close. No live updates.
